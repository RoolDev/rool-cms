            ...
            <div className="mt-3">
              <ReactMarkdown
                ...
                renderers={{
                  ...
                  table: (args) => {
                    return (
                      <table className="table-auto">{args.children}</table>
                    );
                  },
                  tableCell: (args) => {
                    if (args.isHeader)
                  ...
                  paragraph: (args) => {
                    return (
                      <p className="leading-tight text-base antialiased text-justify">
                        {args.children}
                      </p>
                    );
                  },
                  list: (args) => {
                    return (
                      <ul className="list-inside list-disc">{args.children}</ul>
                    );
                  },
                  blockquote: (args) => {
                    return (
